...
const GLOBAL_SUMMARIES: Record<number, SummaryProblem[]> = {
  ...
  7: [
    ...
    { numero: "3", titulo: "Preparando para Gerar uma Nova Vida", conteudo: { "Pré-natal": "Protocolos de acompanhamento da gestante, exames de rotina e suplementação." } },
    { numero: "4", titulo: "Chegando ao Mundo na Correria", conteudo: { "Parto e Emergências": "Fisiologia do trabalho de parto, estágios e assistência imediata." } },
    { numero: "5", titulo: "Hora da Prova", conteudo: { "Avaliação Fetal": "Métodos diagnósticos, cardiotocografia e vitalidade fetal." } }
  ],
  ...
  8: [
    ...
    { numero: "2", titulo: "Um Início Delicado", conteudo: { "Icterícia e Vitaminas": "Metabolismo da bilirrubina, profilaxia com Vitamina K e Vitamina A." } },
    { numero: "3", titulo: "Crescendo com Saúde", conteudo: { "Imunologia e Leite": "Amamentação, banco de leite e calendário vacinal do PNI." } },
    { numero: "4", titulo: "Peculiaridades do Desenvolvimento", conteudo: { "Puericultura": "Marcos do desenvolvimento motor, cognitivo e teorias de Piaget/Freud." } },
    { numero: "5", titulo: "Mais um 5 pra Ele", conteudo: { "Apgar e Vitalidade": "Avaliação retrospectiva e manejo de patologias neonatais comuns." } }
  ],
